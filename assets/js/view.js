export default class FightView{
    ...
    update(roundInfo){
        ...
        // const attackIconPath = '../imgs/sword.svg';
        // this.p1Text.innerHTML = `<img src="${attackIconPath}" width="24" height="24" alt="Attack Icon"> ${this.model.p1.stats.maxAttack}`;
        ...
        this.roundDiv.innerText = `Round: ${roundInfo.round}`;
